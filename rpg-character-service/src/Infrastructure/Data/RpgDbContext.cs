    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
      ...
      modelBuilder.Entity<AbilityScoreEntity>(entity => {
        ...
        entity
          ...
          .IsRequired();
        entity
          .HasIndex(e => new {e.CharacterId, e.AbilityType})
          .IsUnique();
      ...
      modelBuilder.Entity<ArmorStatsEntity>(entity => {
        ...
        entity
          ...
          .UseIdentityColumn();
        entity
          .Property(e => e.BaseArmorClass)
          .IsRequired()
          .HasDefaultValue(0);
        entity
          .Property(e => e.ArmorType)
          .IsRequired();
        entity
          .HasIndex(e => e.ItemId)
          .IsUnique();
      ...
      modelBuilder.Entity<WeaponStatsEntity>(entity => {
        ...
        entity
          ...
          .UseIdentityColumn();
        entity
          .Property(e => e.WeaponProperties)
          .IsRequired()
          .HasDefaultValue(0);
        entity
          .Property(e => e.RangeType)
          .IsRequired()
          .HasDefaultValue(0);
        entity
          .HasIndex(e => e.ItemId)
